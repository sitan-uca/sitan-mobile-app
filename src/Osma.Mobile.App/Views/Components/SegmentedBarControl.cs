...
namespace Osma.Mobile.App.Views.Components
{
    public class SegmentedBarControl : ContentView
    {
        ...
        public static readonly BindableProperty SelectedItemChangedCommandProperty = 
            BindableProperty.Create(nameof(SelectedItemChangedCommand), typeof(Command<string>), typeof(SegmentedBarControl), default(Command<string>), BindingMode.TwoWay, null, SelectedItemChangedCommandPropertyChanged);
